function expoDataSet = ReadExpoXML_old(filename, doSpikeWaveforms, beVerbose)
...
global output matrix blocks slots passes analog spiketimes environment waveforms
...
if ~strcmp(output.ExpoVersion, output.MatlabImportVersion)
    warning('ExpoMatlab:ReadExpoXML','The xml was generated from version %s of Expo whereas this Matlab code was written for version %s.',output.ExpoVersion, output.MatlabImportVersion)
end
if verbose, fprintf('File name %s\n', output.FileName); end
return
...
% function [token eof] = GetNextToken()
...
global linenum blocknum slotnum passnum analognum spikenum waveChannelNum waveformnum verbose totalpasses
...
if verbose
    fprintf(['Number of blocks: %d\n', ...
        ...
        blocknum, slotnum, passnum, analognum, spikenum, waveChannelNum, waveformnum);
end
...
global textfile tokenlist currentLine linenum paramlist;
