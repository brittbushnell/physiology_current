...
%
%ExpoXMLimport = ReadXMLandNEV('file1','file2'[,'file3'][,'nomat'][,'save'],[,'regen'])
%
...
%
%     The intermediate mat files for the XML and NEV files aren't used.
%     Everything is computed de novo.
