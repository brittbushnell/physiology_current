...
Handles.holdTheLine = uicontrol('Parent',h0, ...
	...
	'String',mat7, ...
    'Callback','spikesort_gui history',...
	'Style','checkbox', ...
	'Tag','HistoryEnable', ...
	'UserData','[ ]', ...
	'Value',1);
...
uicontrol('Parent',h0, ...
	...
	'ListboxTop',0, ...
        'Units','normalized', ...
	'Position',[.015 .285 .1 .055], ...
	'String','Move to:', ...
	'Tag','Pushbutton1');
Handles.toMove = uicontrol('Parent',h0, ...
	'BackgroundColor',[1 1 1], ...
        'Units','normalized', ...
	'Position',[.015 .08 .1 .195], ...
	'String',mat7, ...
	'Style','listbox', ...
	'Tag','LineStyle', ...
	'UserData','[ ]', ...
