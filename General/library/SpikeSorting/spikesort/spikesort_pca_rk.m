function spikesort_pca_rk(filenames, readNewUnits)
...
k0 = figure('Color',[0.8 0.8 0.8], ...
    'Colormap',mat0, ...
    'MenuBar','none', ...
    'Name','PCA', ...
    'NumberTitle','off', ...
    'Position',[1964 668 576 486], ...
    'Tag','PCA', ...
    'ToolBar','none', ...
    'Visible','on');
Handles.pcaFigure = k0;

Handles.pcaspace = axes('Parent',k0, ...
    'Units','pix', ...
    'Box','off', ...
...
Handles.history = uicontrol('Parent',j0, ...
    ...
    'String','', ...
    'Style','listbox', ...
    'Callback','spikesort_gui_pca_rk changeHistory', ...
    'Tag','History', ...
    'UserData',[], ...
    'Value',0);
...
uicontrol('Parent',j0, ...
    'Callback','spikesort_gui_pca_rk clear_history', ...
    'ListboxTop',0, ...
    'Units','normalized', ...
...
h0 = figure('Color',[0.8 0.8 0.8], ...
    ...
    'Tag','Fig1', ...
    'ToolBar','none',...
    'keypressfcn','spikesort_gui_pca_rk keyfcn');
...
Handles.holdTheLine = uicontrol('Parent',h0, ...
    ...
    'String',mat7, ...
    'Callback','spikesort_gui_pca_rk history',...
    'Style','checkbox', ...
    'Tag','HistoryEnable', ...
    'UserData','[ ]', ...
    'Value',1);
...
Handles.channel = uicontrol('Parent',h0, ...
    ...
    'Style','listbox', ...
    'Tag','ChannelNo', ...
    'Callback','spikesort_gui_pca_rk load', ...
    'UserData','[ ]', ...
    'Value',1);

uicontrol('Parent',h0, ...
    'Callback','spikesort_gui_pca_rk sample', ...
    'ListboxTop',0, ...
    'Units','normalized', ...
...
uicontrol('Parent',h0, ...
    'Callback','spikesort_gui_pca_rk threshold', ...
    'ListboxTop',0, ...
    'Units','normalized', ...
...
uicontrol('Parent',h0, ...
    'Callback','spikesort_gui_pca_rk clear_threshold', ...
    'ListboxTop',0, ...
    'Units','normalized', ...
...
Handles.scalefactor = uicontrol('Parent',h0, ...
    'Style','Slider',...
    'Callback','spikesort_gui_pca_rk set_scalefactor', ...
    'Units','normalized', ...
...
Handles.sortCodes = uicontrol('Parent',h0, ...
    ...
    'Value',1, ...
    'Max',2, ...
    'Callback', 'spikesort_gui_pca_rk update');

uicontrol('Parent',h0, ...
    'Callback','spikesort_gui_pca_rk moveSelected', ...
    'ListboxTop',0, ...
    'Units','normalized', ...
...
uicontrol('Parent',h0, ...
    'Callback','spikesort_gui_pca_rk write', ...
    'ListboxTop',0, ...
    'Units','normalized', ...
