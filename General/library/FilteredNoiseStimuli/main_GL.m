clear
clc, close all
%% This version used by Gerick Lee, 2018-07-23
%%% -- General Params -- %%%
cm2deg = @(s, d) 2 * atand(s/(2 * d));
ppd = 1280 / cm2deg(40, 144); % pixels per degree
imN = 80; % size in pixels
sizeDeg = imN/ppd; % size in degrees
nSamp = 1; % samples per filter
saveDir = [pwd, '/images_Gerick'];
fileExt = '.png';
