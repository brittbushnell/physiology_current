function [PSTH,PSTHndxs]=extractspectrum(ExpoXMLimport)
%
...
load ~/Matlab/analysis/m645/mat/m645l2#3[LSRC].mat;
...
ns6filename = sprintf('/experiments/m%s_array/recordings/ns6/m%s%s#%03d.ns6',monkey,monkey,hemi,str2double(exp));
ns2filename = sprintf('/experiments/m%s_array/recordings/ns2/m%s%s#%03d.ns2',monkey,monkey,hemi,str2double(exp));

%% PROCESSING FILE
[nsdata6,nsheader6] = getNSxData(ns6filename);
[nsdata2,nsheader2] = getNSxData(ns6filename);
