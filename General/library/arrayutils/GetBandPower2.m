function GetBandPower(xmlFileName,nevFileName,ns6fileName,bandPowerFileName,passDuration,bandCutoff)
% GetBandPower(xmlFileName,nevFileName,ns6fileName,bandPowerFileName,passDuration,bandCutoff)
%
...
startTimes = D1.passes.StartTimes;
startInd = ceil(double(startTimes./scale+offset)*fsPow/fsExpo);
