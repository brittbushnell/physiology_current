function bin_spike_bushnell10_gratings(fileNAME,prefix_dir,OUTPUT_DIR,plotNEVTimestamp)
...
if strfind(fileNAME,'nsp1')
    if strfind(fileName,'WU')
        if strfind(fileNAME, 'recut')
            BLACKROCK_DIR = [prefix_dir, 'nsp1/nsp1_blackrock/WU_recut/'];
            MWORKS_DIR = [prefix_dir, 'nsp1/mworks/WU_recut/'];
        else
            BLACKROCK_DIR = [prefix_dir, 'nsp1/nsp1_blackrock/WU'];
            MWORKS_DIR = [prefix_dir, 'nsp1/mworks/WU'];
        end
    elseif strfind(fileName,'WV')
        if strfind(fileNAME, 'recut')
            BLACKROCK_DIR = [prefix_dir, 'nsp1/nsp1_blackrock/WV_recut/'];
        else
            BLACKROCK_DIR = [prefix_dir, 'nsp1/nsp1_blackrock/WV'];
            MWORKS_DIR = [prefix_dir, 'nsp1/mworks/WV'];
        end
    else
        if strfind(fileNAME, 'recut')
            BLACKROCK_DIR = [prefix_dir, 'nsp1/nsp1_blackrock/XT_recut/'];
        else
            BLACKROCK_DIR = [prefix_dir, 'nsp1/nsp1_blackrock/XT'];
            MWORKS_DIR = [prefix_dir, 'nsp1/mworks/XT'];
        end
    end
else
    if strfind(fileName,'WU')
        if strfind(fileNAME, 'recut')
            ...
            BLACKROCK_DIR = [prefix_dir, 'nsp2/nsp2_blackrock/WU'];
            MWORKS_DIR = [prefix_dir, 'nsp1/mworks/WU'];
        end
    elseif strfind(fileName,'WV')
        if strfind(fileNAME, 'recut')
...
save([OUTPUT_DIR, save_name], 'stimOn', 'starting_phase', 'direction', 'o_starting_phase',...
