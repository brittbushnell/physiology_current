function [stimBlankPval,gCh] = getPermutationStatsAndGoodCh(realData,permData)
% glassGetPermutationStats(realData,permData)
%
% INPUT:
% REAL DATA:
%  vector of observed d' values for stimulus versus blank
%
% PERM DATA:
%  matrix of permuted d' values for stimulus versus blank. There should be
%  2000 d' values per channel.

%
% OUTPUT:
%  stimBlankPval
%     A (1,96) vector of p-values from the permutation test comparing the
