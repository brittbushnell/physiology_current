...
xlim([xMin xMax])
ylim([0 0.8])
% histogram(V1prefConZsLE,'BinWidth',0.2,'EdgeColor','w','FaceColor',[0.7 0 0.7],'Normalization','probability')
histogram(V1prefConZsLE,'EdgeColor','w','FaceColor',[0.7 0 0.7],'Normalization','probability')
...
hold on
 xlim([xMin xMax])
ylim([0 0.8])
% histogram(V1prefRadZsLE,'BinWidth',0.2,'EdgeColor','w','EdgeColor','w','FaceColor',[0 0.6 0.2],'Normalization','probability')
histogram(V1prefRadZsLE,'EdgeColor','w','EdgeColor','w','FaceColor',[0 0.6 0.2],'Normalization','probability')
...
%  xlim([xMin xMax])
ylim([0 0.8])
% histogram(V1prefNozZsLE,'BinWidth',0.2,'EdgeColor','w','FaceColor',[1 0.5 0.1],'Normalization','probability')
histogram(V1prefNozZsLE,'EdgeColor','w','FaceColor',[1 0.5 0.1],'Normalization','probability')
...
ylim([0 0.8])
histogram(V4prefConZsLE,'BinWidth',0.2,'EdgeColor','w','FaceColor',[0.7 0 0.7],'Normalization','probability')
...
ylim([0 0.8])
histogram(V4prefRadZsLE,'BinWidth',0.2,'EdgeColor','w','FaceColor',[0 0.6 0.2],'Normalization','probability')
...
text(-5,0.18,'V4','FontSize',20,'FontWeight','bold','FontAngle','italic');
...
ylim([0 0.8])
histogram(V4prefNozZsLE,'BinWidth',0.2,'EdgeColor','w','FaceColor',[1 0.5 0.1],'Normalization','probability')
...
ylim([0 0.8])
histogram(V1prefConZsRE,'BinWidth',0.2,'EdgeColor','w','FaceColor',[0.7 0 0.7],'Normalization','probability')
...
ylim([0 0.8])
histogram(V1prefRadZsRE,'BinWidth',0.2,'EdgeColor','w','FaceColor',[0 0.6 0.2],'Normalization','probability')
...
ylim([0 0.8])
histogram(V1prefNozZsRE,'BinWidth',0.2,'EdgeColor','w','FaceColor',[1 0.5 0.1],'Normalization','probability')
...
ylim([0 0.8])
histogram(V4prefConZsRE,'BinWidth',0.2,'EdgeColor','w','FaceColor',[0.7 0 0.7],'Normalization','probability')
...
ylim([0 0.8])
histogram(V4prefRadZsRE,'BinWidth',0.2,'EdgeColor','w','FaceColor',[0 0.6 0.2],'Normalization','probability')
...
ylim([0 0.8])
histogram(V4prefNozZsRE,'BinWidth',0.2,'EdgeColor','w','FaceColor',[1 0.5 0.1],'Normalization','probability')
