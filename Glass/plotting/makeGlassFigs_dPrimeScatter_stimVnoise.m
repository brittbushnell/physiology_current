...
text(-0.55, 2.35,sprintf('R2 %.3f',conReg(1)),'FontSize',12)
...
text(-0.55, 2.35,sprintf('R2 %.3f',radReg(1)),'FontSize',12)
...
text(-0.55, 2.35,sprintf('R2: %.3f',trLEReg(1)),'FontSize',12)
...
figName = [V1data.conRadRE.animal '_glassdPrimeScatters_vsNoise_3plot','.pdf'];
set(gcf,'InvertHardCopy','off')
print(gcf, figName, '-dpdf', '-bestfit')
