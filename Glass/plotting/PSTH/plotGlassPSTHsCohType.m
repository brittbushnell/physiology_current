...
print(gcf, figName,'-dpdf','-fillpage')
%% high coherence concentric vs noise
figure (4)
clf
pos = get(gcf,'Position');
set(gcf,'Position',[pos(1) pos(2) 1500 1200])
...
suptitle(sprintf('%s %s %s concentric 100% Glass pattern vs noise',dataT.animal, dataT.array, dataT.eye))
figName = [dataT.animal,'_',dataT.eye,'_',dataT.array,'_',dataT.programID,'_PSTH_sigConc'];
print(gcf, figName,'-dpdf','-fillpage')
