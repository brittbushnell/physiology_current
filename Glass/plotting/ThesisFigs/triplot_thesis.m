...
figure(1)
clf
set(gcf,'Position',[34 177 400 900],'PaperSize',[5, 9.75]);
...
c2 = colorbar(ax,'Position',[0.84 0.475 0.02 0.3]);
...
text(-2.2,-1.2,sprintf('V1 CoM distance: %.2f ',v1Dist),'FontSize',12)
if pValV4>0.05
...
if pValV1 >0.05
    text(0.85,-1.2,sprintf('p = %.2f',pValV1),'FontSize',12)
else
    text(0.85,-1.2,sprintf('p = %.2f*',pValV1),'FontSize',12)
end
...
text(-0.6,0.95,'Translational','FontSize',12)
