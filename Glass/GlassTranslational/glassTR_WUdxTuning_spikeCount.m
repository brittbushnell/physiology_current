...
%%
% TODO: 
% - have to do a big redo; can't plot d' in polar plots because negative
% values cross the center.  Need to do spike counts so need to go back to
% the start and identify the correct channels and densities based on OSI
% and d', then pull those parameters from spike count matrix.
%%
