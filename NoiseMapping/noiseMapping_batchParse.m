...
addpath(genpath('/home/bushnell/binned_dir'))
addpath(genpath('/home/bushnell/matFiles'))
addpath(genpath('/home/bushnell/mworks'))
addpath(genpath('/home/bushnell/mworksSupportMatlab'))
addpath(genpath('/mnt/vnlstorage/bushnell_arrays/'))
%%
animal      = 'XT';
arrayID     = 'nsp2';
eye         = 'LE';
...
for iF = 1:length(fileList)
   % try
        ...
        if ~exist(processedFile)
            bin_spike_bushnell11_png(filename, dataDir, outputDir, plotNEVTimestamps);
