...
daily = 0; % if putting in multiple days and want to run the analysis for each day, rather than the concatenated versions, this will save the data structures for each day as individual files.
dispPSTH = 0;
saveData = 1;
...
%% XT
% files = 'XT_RE_gratings_V1_20181028_means';
% newName = 'XT_RE_gratings_V1_20181028_fit';
%% WV
% files = ['WV_RE_Gratings_V4_20190205_means'];
% newName = 'WV_RE_Gratings_V4_20190205_fit';

% files = ['WV_LE_Gratings_V4_20190205_means'];
% newName = 'WV_LE_Gratings_V4_20190205_fit';

  files = ['WV_RE_Gratings_V4_20190205_means';'WV_LE_Gratings_V4_20190205_means'];
  newName = 'WV_Gratings_V4_20190205_fit';
...
if strfind(filename,'V1')
    ...
    elseif location  == 1
        cd ~/bushnell-local/Dropbox/ArrayData/matFiles/V4/Gratings/FittedMats/
    elseif location  == 0
