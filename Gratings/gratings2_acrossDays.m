...
dataDir         = '/Local/Users/bushnell/Dropbox/ArrayData/matFiles/unsorted/XT/'; %'/e/4.3/p1/bushnell/mnt/vnlstorage/bushnell_arrays/'; 
% zemina
%dataDir = '/mnt/vnlstorage/bushnell_arrays/'; %%'/home/bushnell/binned_dir/XT/';

if strmatch(arrayID,'nsp2')
    outputDir       = '/Local/Users/bushnell/Dropbox/ArrayData/matFiles/V4/Gratings/XT';
    figureDir       = '/home/bushnell/Figures/XT/V4/Gratings/';
else
    outputDir       = '/Local/Users/bushnell/Dropbox/ArrayData/matFiles/V1/Gratings/XT';
    figureDir       = '/home/bushnell/Figures/XT/V1/Gratings/';
end
...
fileList        = getBlackrockRecFileListMat(dataDir, arrayID, eye, 'gratings',animalID);
