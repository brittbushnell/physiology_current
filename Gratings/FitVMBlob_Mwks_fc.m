function [paramOut, bhat, funbest] = FitVMBlob_Mwks_fc(oris, sfs, respMat, nStarts)
% Inputs:
...
for iistart = 1:nStarts
    ...
    %[param,fun] = fminsearch(fnVMBlob, this_beta0, options); % Tom's
    %suggestion, get rid of the bounds. fminsearch isn't working without it
    %though, says there are not enough inputs.
