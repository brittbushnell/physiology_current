...
% low SF
% files = ['XT_RE_radFreqLowSF_nsp1_Dec2018'; 'XT_LE_radFreqLowSF_nsp1_Dec2018'];
% newName = 'XT_radFreqLowSF_V1_ManualLocs_cleaned';

% files = ['XT_RE_radFreqLowSF_nsp2_Dec2018'; 'XT_LE_radFreqLowSF_nsp2_Dec2018'];
% newName = 'XT_radFreqLowSF_V4_ManualLocs_cleaned';

%highSF
% files = ['XT_RE_radFreqHighSF_nsp1_Dec2018'; 'XT_LE_radFreqHighSF_nsp1_Jan2019'];
% newName = 'XT_radFreqHighSF_V1_ManualLocs_cleaned';
% 
%  files = ['XT_RE_radFreqHighSF_nsp2_Dec2018'; 'XT_LE_radFreqHighSF_nsp2_Jan2019'];
%  newName = 'XT_radFreqHighSF_V4_ManualLocs_cleaned';
%% WV highSF
files = ['WV_LE_RadFreqHighSF_nsp2_March2019';'WV_RE_RadFreqHighSF_nsp2_March2019'];
newName = 'WV_RadFreqHighSF_V4_cleaned';

% files = 'WV_LE_RadFreqLowSF_nsp2_March2019';
% newName = 'WV_LE_RadFreqLowSF_V4_March2019';
%%
location = 0; %0 = laptop 1 = desktop 2 = zemina
startBin = 5;
endBin = 35;
dbg = 0; % if testing and debugging, will do last chunk and make more figures
%% Get array map
