...
%                    errorbar(2,REmuBS{ch}(end,1),REste{ch}(end,1),'r-o','LineWidth',2)
                ...
                if LEdata.goodCh(ch) == 1
                    ...
                    plot([2 128], [0 0], ':k')
                    set(gca('XTickLabel',{'circle','low','','','','','high'},'XTickLabelRotation', 45))
                %ylim([yMin yMax])
...
for rf_n = 1:3
    for cond_n = 1:4
        ...
        if (rf_n == 1 && cond_n == 2)
            title('Size = 1 deg SF = 2 cpd');
        elseif (rf_n == 1 && cond_n == 3)
            title('Size = 2 deg SF = 1 cpd');
        elseif (rf_n == 1 && cond_n == 4)
            title('Size = 2 deg SF = 2 cpd');
        end
        ...
        if rf_n == 1
            topTitle = 'Distribution of slopes across eyes for each RF set';
            annotation('textbox',...
                [0.2 0.96 0.65 0.05],...
                'LineStyle','none',...
                'String',topTitle,...
