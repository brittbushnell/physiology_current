...
for fi = 1:length(files)
    ...
    if contains(filename,'WU')
        [V1data.IOD.dpPval,V1data.IOD.dpSigPerms,V1data.IOD.corrPval,V1data.IOD.corrSigPerms,...
            V1data.IOD.maxDpPopDiff,V1data.IOD.maxDpChDiff, V1data.IOD.corrChDiff,V1data.IOD.corrPopDiff]...
        ...
        [V4data.IOD.dpPval,V4data.IOD.dpSigPerms,V4data.IOD.corrPval,V4data.IOD.corrSigPerms,...
            V4data.IOD.maxDpPopDiff,V4data.IOD.maxDpChDiff, V4data.IOD.corrChDiff,V4data.IOD.corrPopDiff]...
