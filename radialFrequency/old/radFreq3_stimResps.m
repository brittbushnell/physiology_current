...
%REdata.goodCh = REdata.goodChannels;
%LEdata.goodCh = LEdata.goodChannels;
...
%                             LEste1(i) = LEdata.stimResps{ch}(20,LEndx(i));
                            REndxBS(i) = (REdata.stimResps{ch}(end-2,REndx(i)));
                            LEndxBS(i) = (LEdata.stimResps{ch}(end-2,LEndx(i)));
                            
                            REndx2(i) = (REdata.stimResps{ch}(end-3,REndx(i)));
                            LEndx2(i) = (LEdata.stimResps{ch}(end-3,LEndx(i)));
