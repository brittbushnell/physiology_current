...
figure(2)
clf
s = suptitle(sprintf('%s %s Fisher Z distributions by location',REdata.animal, REdata.array));
...
set(th,'Rotation',90)
%%
figName = [REdata.animal,'_BE_',REdata.array,'_FisherT_location_dist','.pdf'];
