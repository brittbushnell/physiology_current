...
for ch = 1:96
    ...
    if ~contains(LEdata.animal,'WU')
        figName = [LEdata.animal,'_BE_',LEdata.array,'_',LEdata.programID,'_sfPrefs_ch',num2str(ch),'.pdf'];
    else
        figName = [LEdata.animal,'_BE_',LEdata.array,'_sfPrefs_ch',num2str(ch),'.pdf'];
    end
